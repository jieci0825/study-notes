...
![image-20240109003502700](./babel的安装和使用.assets/image-20240109003502700.png)
...
![](./babel的安装和使用.assets/2020-02-07-10-25-56.png)

由于语言的转换工作灵活多样，babel的做法和postcss、webpack差不多，它本身仅提供一些分析功能，真正的转换需要依托于插件完成

![](./babel的安装和使用.assets/2020-02-07-10-27-30.png)
